...
| ------------------- | ------------------------------------------ | ------------------------------------------- | ------------ |
| **Architecture**    | "plan", "structure", "orchestrate"         | `vitalia-architect`                         | ✅ YES       |
| **Authentication**  | "login", "auth", "signup", "password"      | `vitalia-backend` + `security-auditor`      | ✅ YES       |
| **Vitalia UI**      | "dashboard", "component", "shadcn"         | `vitalia-frontend`                          | ✅ YES       |
| **Backend/API**     | "endpoint", "django", "service", "async"   | `vitalia-backend`                           | ✅ YES       |
| **Database**        | "schema", "migration", "pgvector"          | `vitalia-backend` + `database-architect`    | ✅ YES       |
| **AI/RAG**          | "rag", "ollama", "prompt", "llm"           | `vitalia-ai`                                | ✅ YES       |
| **DevOps**          | "deploy", "docker", "script", "backup"     | `vitalia-devops`                            | ✅ YES       |
| **UX/Design**       | "design", "figma", "flow", "accessibility" | `vitalia-ux`                                | ✅ YES       |
...
function analyzeRequest(userMessage) {
    ...
    if (complexity === "SIMPLE" && domains.length === 1) {
        ...
        return "vitalia-architect"; // Default to Master Vitalia for complex tasks
    }
}
```
...
```markdown
🤖 **Applying knowledge of `@vitalia-backend`...**
...
| --------------- | ------------------------------------------ | ----------------------- |
| **Orchestration**| plan, architecture, vitalia, master       | `vitalia-architect`     |
| **Backend**     | api, django, python, async, service        | `vitalia-backend`       |
| **Frontend**    | react, nextjs, tailwind, ui, component     | `vitalia-frontend`      |
| **AI/ML**       | ai, rag, llm, prompt, embedding            | `vitalia-ai`            |
| **DevOps**      | docker, ci/cd, script, bash, infra         | `vitalia-devops`        |
| **UX/Design**   | ux, ui design, figma, accessibility        | `vitalia-ux`            |
